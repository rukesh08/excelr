...
public class AdminRestaurantController {
    ...
    public ResponseEntity<Restaurant> updateRestaurant(
        ...
        restaurantService.getRestaurantByUserId(userService.findUserByJwtToken(jwt).getId()); // example check
    ...
    public ResponseEntity<String> rejectRestaurant(@PathVariable Long id) throws Exception {
